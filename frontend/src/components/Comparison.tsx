    ...
    return (
      <section className="section-perf border-y border-white/5 bg-ink py-14 md:py-16">
        <Container>
          ...
          <div className="grid gap-3 sm:gap-4 max-[720px]:grid-cols-1 min-[721px]:grid-cols-2">
            {comparison.us.slice(0, 2).map((item, i) => (
              <Reveal key={item} delay={i * 80}>
                <div className="pro-card flex gap-2.5 p-5 text-[14px] sm:text-[14.5px]">
